...
public class DailyAllowanceMapper {
  public DailyAllowance mapDailyAllowanceResponseToDailyAllowance(
      DailyAllowanceResponse dailyAllowanceResponse) {
  ...
  public DailyAllowance mapDailyAllowanceRequestToDailyAllowance(
      DailyAllowanceRequest dailyAllowanceRequest) {
  ...
  public DailyAllowance mapDailyAllowanceRequestToDailyAllowanceUpdate(
      DailyAllowanceRequest dailyAllowanceRequest, Long id) {
  ...
  public DailyAllowanceResponse mapDailyAllowanceToDailyAllowanceResponse(
  ...
  public DailyAllowanceRequest mapDailyAllowanceToDailyAllowanceRequest(
      DailyAllowance dailyAllowance) {
  ...
  public List<DailyAllowanceResponse> mapDailyAllowanceListToDailyAllowanceResponseList(
